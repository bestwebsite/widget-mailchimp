<?php
/*
Plugin Name: Bestwebsite MailChimp Widget
Plugin URI: https://github.com/bestwebsite/widget-mailchimp
...
function Bestwebsite_mailchimp_widget_generic_error() {
	printf('
...
try {
	...
	add_action('admin_notices', 'Bestwebsite_mailchimp_widget_generic_error');
}
